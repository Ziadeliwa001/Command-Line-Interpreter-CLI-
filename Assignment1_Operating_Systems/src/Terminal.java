...
//        if (args.length == 0) {
//            System.out.println("Usage: java CustomMkdir directoryName1 directoryName2 ...");
//            return;
//        }
        ...
        for (String arg : args) {
            ...
            if (newDir.exists() && newDir.isDirectory()) {
                ...
                if (arg.contains(File.separator)) {
                    ...
                    File parentDir = new File(arg.substring(0, arg.lastIndexOf(File.separator)));
                    if (!parentDir.exists()) {
                        System.out.println("Parent directory '" + parentDir.getPath() + "' doesn't exist. Directory not created.");
                        continue;
                    }
                ...
                if (created) {
                    System.out.println("Directory '" + arg + "' created successfully.");
                } else {
    ...
    public void cp_r(String[] args) {
        if (args.length != 2) {
            ...
            if (!sourceDir.exists() || !sourceDir.isDirectory()) {
                ...
                System.out.println("Destination exists but is nolst a directory.");
            } else {
                try {
    ...
    public void rm(String fileName){
        ...
        if (file.exists() && file.isFile()) {
            ...
            if (deleted) {
                System.out.println("File '" + fileName + "' has been successfully removed.");
            } else {
